...
#get the location of the eyes(dlib used for facial land mark detection)
...
# frame indicate that five successive frames with an eye aspect ratio less than EYE_AR_THRESH must
#happen in order for a blink to be registered.
ar_thresh = 0.3
